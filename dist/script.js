...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var differences = new _modules_difference__WEBPACK_IMPORTED_MODULE_3__["default"]('.officerold', '.officernew', '.officer__card-item');
  differences.init();
...
function () {
  function Form(forms) {
    ...
    this.message = {
      loading: 'Данные отправляются, ожидайте...',
...
function (_Slider) {
  ...
  _createClass(MainSlider, [{
    ...
    key: "bindTriggers",
    value: function bindTriggers(btnsModul, n) {
      var _this3 = this;

      btnsModul.forEach(function (btn) {
        btn.addEventListener('click', function (e) {
          e.stopPropagation();
          e.preventDefault();
